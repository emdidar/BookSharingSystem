...
?>
    ...
    <section class="recent-book-sec">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        ...
                        <h6><span class="price">TK <?php echo $productResult['vPrice']; ?></span> / <a href="product-single.php?id=<?php echo $productResult['iAutoId']; ?>">Buy Now</a></h6>
                    </div>
                </div>
            ...
            <div class="btn-sec">
                <a href="product-single.php" class="btn gray-btn">view all books</a>
            </div>
        </div>
    </section>
