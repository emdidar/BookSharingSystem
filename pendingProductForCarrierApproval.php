...
<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Pending Product for Carrier Approval</h4>
            <hr>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="vStatus" required>
                            <option
                            <?php
                                if($productResult['vStatus']=='pending for carrier Approval') { ?> selected="selected" <?php } ?> value="pending for carrier Approval">pending for carrier Approval
                            </option>
                            <option
                            <?php
                            ...
                            <option
                            <?php
                                if($productResult['vStatus']=='reject') { ?> selected="selected" <?php } ?> value="reject">reject
                            </option>
                        </select>
                    </div>
                </div>
